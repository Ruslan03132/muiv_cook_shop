...
public class RecyclerViewAdapterSoup extends RecyclerView.Adapter<RecyclerViewAdapterSoup.ViewHolder> implements Filterable {

    private ArrayList<InfoCardItem> cardItemsSoup;
    private ArrayList<InfoCardItem> cardItemsFullSoup;
        ...
        private ViewHolder(@NonNull View itemView) {
            ...
            this.buttonBasket.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Menu menu = MainActivity.databaseHandler.getRecipes(position + 1, "soupRecipes");
                    InfoCardItem cardItem = cardItemsSoup.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, RecipeSoupActivity.class);
                    intent.putExtra("title" , cardItem.getTitle());
                    intent.putExtra("description" , cardItem.getDescription());
                    intent.putExtra("recipe" , cardItem.getRecipe());
                    intent.putExtra("imageResourse" , cardItem.getImageView());
    ...
    RecyclerViewAdapterSoup(ArrayList<InfoCardItem> cardItems , Context context){
        this.cardItemsSoup = cardItems;
        this.context = context;
        this.cardItemsFullSoup = new ArrayList<>(cardItems);
    }
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterSoup.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0){
                filteredList.addAll(cardItemsFullSoup);

            }
            else {
                String filterPattern = constraint.toString().toLowerCase().trim();
                for (InfoCardItem item: cardItemsFullSoup){
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            cardItemsSoup.clear();
            cardItemsSoup.addAll((List) results.values);
